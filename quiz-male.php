        ...
        <div class="container">
            <form class="multisteps_form" id="wizard" method="GET" action="perfil.php">
                ...
                <div class="multisteps_form_panel step">
                    ...
                    <div  style="margin-top:50px" class="question_title py-5  text-center text-uppercase">
                ...
                <div class="multisteps_form_panel step">
                    ...
                    <div  style="margin-top:50px" class="question_title py-5  text-center uppercase">
