...
<html lang="en">
  ...
  <body>
    ...
    <div class="page page_simple">
      <div class="entry">
        <div class="entry__wrapper"><a class="entry__logo" href="#"></a>
          <div class="h2 entry__title">Entrar</div>
          ...
          <div class="entry__fieldset">
            ...
            </div><a class="button entry__button" href="dashboard.php">Entrar</a>
          </div>
          ...
          <div class="entry__info">Não tem conta? <a href="signup.php">Cadastre-se</a></div>
        </div>
      </div>
    </div>
    <!-- scripts-->
