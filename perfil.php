...
if (isset($_GET["sexo"]) == "MASCULINO") {
    ...
    if ($letra == "A") {
        $perfil = "CASUAL";
        $descricao = "<br>
        Livre e Extrovertido, sempre em movimento, mas com aquele toque de naturalidade, ama natureza. Curte um ar livre, sol e ama de se aventurar no mar. 
        <strong>Notas:</strong> Aquosas, Verdes e Cítricas garantindo ao mesmo tempo características leves e marcantes.";
    }
    if ($letra == "B") {
        $perfil = "CONQUISTADOR";
        $descricao = "<br>
       
        Gosta de ser bem recebido em todos os lugares, pois seu maior triunfo é conquistar, irresistível e discreto, mas naturalmente moderno e inesperado. 
       <strong> Notas:</strong> Amadeirado e Amber levemente Adocicado sem esquecer as notas Aromáticas e Cítricas.";
    }

    if ($letra == "C") {
        $perfil = "SEDUTOR";
        $descricao = "
        Está em constante desafio, ama ir além dos seus limites. Conhecido por seu perfil negociador e ótimo poder de persuasão, conseguir o que quer está em sua natureza.   
        <strong> Notas:</strong> Orientais com Especiarias, notas de Gourmand às vezes.";
    }

    if ($letra == "D") {
        $perfil = "SOFISTICADO";
        $descricao = 'Com charme natural e orgulhoso de sua aparência, abusa de seu magnetismo e cultiva a arte de viver.Com sua autoconfiança e segurança, sabe exatamente o que quer.
        <strong> Notas: </strong> Amadeirado e Amber com toques Florais e de Especiarias Quentes.';
    }
...
<body>
    ...
    <div class="card text-center">
        ...
        <div style="margin-top:10px; padding-left:50px; padding-right: 50px;" class="container ">
            <div class="card">
                <div class="form">
                    <div class="left-side">
                        <div class="row">
