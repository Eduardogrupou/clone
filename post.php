...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="cep" class="cep alert alert-danger alert-dismissible fade show" role="alert">

            <strong>Desculpa!</strong> Infelizmente ainda não atendemos essa região.
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card bg-default mb-3">
                            ...
                            <div class="card-title">
                                ...
                                <ul class="card-toolbar">
                                    ...
                                    <li class="float-left">
                                        ...
                                        <h4 style="font-family:Poppins, sans-serif"><i class="fa fa-map-marker"></i>
                                            Endereço</h4>
                        ...
                        <div class="card-body">
                            ...
                            <form method="GET" action="pagamento.php" class="form-horizontal" role="form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input name="endereco" value="true" hidden class="form-control" /></label><br />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="cep" class="form-control" placeholder="00000-00" type="text"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="rua" type="text" id="rua" size="60" placeholder="Endereço"
                                                class="form-control">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="complemento" require type="text"
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="numero" require type="text" placeholder="Número"
                                                        class="form-control">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input hidden disabled name="ibge" type="text" id="ibge" size="8"
                                                        placeholder="(xx)x xxxx-xxxx" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button type="submit" class="btn btn-default"><i class="fa fa-remove"></i>
                                            Cancelar</button>

                                        <button id="enviar" type="submit"
                                            style="background-color: #ab8e66 ; color:#fff; border-color:#ab8e66"
                                            class="btn btn-primary"><i class="fa fa-arrow-circle-right"></i>
                                            Próximo</button>
