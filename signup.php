...
.login__top{
      ...
      <div class="login">
        <div class="login__col">
          <div class="login__wrap">
            <div class="login__preview"><img src="img/content/login-pic.png" alt="Login"></div>
            <ul class="login__list">
              
            </ul>
          </div>
        </div>
        <div class="login__cul">
        <div class="login-wrapper">
  <div class="login-header">
    <a>
      <div class="login-wrapper">
        <div class="h2 login-title">Cadastre-se</div>
      </div>
       <div class="titulo">
        <div class="login-info">Já tem conta? <a href="login.php">Fazer login</a></div>
      </div>
    </a>
  </div>
    ...
    <p>Não compartilhamos informações de identificação pessoal publicamente ou com terceiros,
                            ...
                            <div class="container-fluid d-flex justify-content-center">
                                <div class="row  d-flex justify-content-center">
                                     ...
                                     <div class="cul-12">
    <input style="margin-top: 40px; background:#ab8e66; color:#fff; border:none"
      id="enviar" type="submit" class="a btn mr-sm-2" name="register" value="Registre-se">
  </div>
  ...
  confirmPasswordInput.addEventListener('input', () => {
    if (passwordInput.value !== confirmPasswordInput.value) {
      passwordError.textContent = 'As senhas não se correspondem.';
    } else {
