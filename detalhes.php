...
if (isset($_GET['id'])) {
    ...
    $query2 = "SELECT * FROM fav WHERE p_id='$p_id' AND u_id='$userId'";

    $favoritos = db::getRecord($query2);
    ...
    <div class="page-wrapper">
        ...
        <nav>
            <div class="container1" style="height:60px; margin-left:2%;  ">
                <a style=" justify-content: end;" id="brand" href="index.php"><img style="height: 30px;"
            ...
            ?>
                    ...
                    <li>
                        ...
                        ?>
                    <li>
                        <a href="login.php"> <i class="w-icon-account"></i> Entrar</a>
                    </li>
                    ...
                    <div class="product product-single row">
                                    ...
                                    <div class="swiper-wrapper row cols-1 gutter-no ">
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <figure class="product-image">
                                                ...
                                                <img src="admin/uploads/<?php echo $products['image']; ?>"
                        ...
                        <div class="col-md-6 mb-4 mb-md-6">
                            ...
                            <div class="product-details">
                                ...
                                <h1 class="product-title"><?php echo $products["name"]; ?></h1>
                                ...
                                <div class="fix-bottom ">
                                    ...
                                    <form method="post" action="action.php?fav=<?php echo $products['id'] ?>&st=1">
                                       ...
                                       if ($favoritos['id']) {
                                      ?>
                                        <input value="Favorito" class="btn btn-primary ">
                                        </input>
                                        <?php  
                                       }else 
                                       { 
        ...
        <div class="container-fluid">
            ...
            <div class="footer-top">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 " style="margin-top:-55px ; margin-left:3%">
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="widget">
                            ...
                            <ul class="widget-body">
                                ...
                                <li><a href="contact-us.php">Sobre Nós</a></li>
                    ...
                    <div class="col-sm-2">
                        ...
                        <div class="widget">
                            ...
                            <h4 class="widget-title">Serviços ao Cliente</h4>

                            <ul class="widget-body">

                                <li><a href="contact-us.php">Métodos de Pagamento</a></li>

                                <li><a href="contact-us.php">Central de Suporte</a></li>

                                <li><a href="contact-us.php">Envio</a></li>

                                <li><a href="contact-us.php">Termos e Condições</a></li>
