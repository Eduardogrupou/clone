  ...
  <div class="page">
    <div class="page__inner">
      <div class="page__container">
        <div class="shop">
          <div class="shop__background"><img src="img/content/bg-shop.jpg" alt="Background"></div>
          <div class="shop__tabs card js-tabs">
            <div class="shop__profile">
              ...
              <div class="shop__contacts">
                <button class="button shop__button">Follow</button>
              </div>
            </div>
            <div class="shop__control">
              <div class="shop__nav"><a class="shop__link js-tabs-link active" href="#">Products</a><a
                  class="shop__link js-tabs-link" href="#">Followers</a><a class="shop__link js-tabs-link"
                  href="#">Following</a></div>
            </div>
