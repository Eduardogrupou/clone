          ...
          <div class="card-header thin-card-header">
              <div class="card-title">
                  <ul class="card-toolbar">
                      <li class="float-left">
                          <h4 style="font-family:Poppins, sans-serif"><i class="fa fa-map-marker"></i> Endereço</h4>
                      </li>
              ...
              <form class="form-horizontal" role="form">
                  <div class="row">
                      <div class="col-lg-6">
                          ...
                          <div class="form-group">
                              <label class="control-label" for="textinput">Rua e Número</label>
                              <input type="text" placeholder="Rua Exemplo, 96" class="form-control">
                          </div>
                          <!-- Text input-->
                          <div class="form-group">
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-6">
                                  <div class="form-group">
                                      ...
                                      <input type="text" placeholder="00000-00" class="form-control">
                                  </div>
                              </div>
                              <div class="col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <div class="form-group">
                                  ...
                                  <input type="text" placeholder="(xx)x xxxx-xxxx" class="form-control">
                              </div>
                          </div>
                          </div>
                     ...
                     <div class="form-group col-lg-6 pr-lg-2">
                      ...
                      <input type="text" placeholder="exemplo@mail.com" class="form-control">
                    </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                      <div class="text-center">
                          ...
                          <button type="submit" style="background-color: #ab8e66 ; color:#fff; border-color:#ab8e66" class="btn btn-primary"><i class="fa fa-arrow-circle-right"></i> Próximo</button>
                      </div>
                  </div>
              </form>
          </div>
