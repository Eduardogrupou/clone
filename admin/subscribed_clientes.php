...
<body class="dark">
  ...
  <div class="page">
    ...
    <div class="page__inner" style="display:padding: 24px 16px; margin-top: -3%;">
      <div class="page__container">
        <div class="page__title h3">Lista de Clientes</div>
        <div class="customer card">
          <div class="card__head">
            <div class="title-purple card__title">Clientes</div>
            <form class="form">
              <input class="form__input" type="text" name="search" placeholder="Pesquise por nome ou Email"
            ...
            <div class="filters">
              ...
              <div class="filters__body">
                <div class="filters__top">
                  <div class="title-red filters__title">Visivel 10 de 24 Clientes</div>
                ...
                <div class="filters__group">
                  <div class="filters__item">
                    <div class="field">
                      <div class="field__label">Filtrar por</div>
                ...
                <div class="filters__btns">
                  <button class="button-stroke filters__button">Aplicar</button>
                  <button class="button filters__button">Limpar</button>
                </div>
              </div>
          ...
          <div class="customer__inner">
              ...
              <div class="customer__wrapper">
                <div class="customer__table">
                  <div class="customer__row">
                    ...
                    <div class="customer__col">Nome</div>
                    <div class="customer__col">Email</div>
                    <div class="customer__col">CEP</div>
                    <div class="customer__col">Id</div>
                    <div class="customer__col">Cidade</div>
                    <div class="customer__col">Sexo</div>
                  </div>
                  <div class="customer__row">
                    <div class="customer__col">
                      <label class="checkbox">
                    ...
                    <div class="customer__col">
                      <div class="customer__item">
                        <div class="customer__avatar"><img src="img/content/avatar-1.jpg" alt="Avatar"></div>
                  ...
                  <div class="customer__row">
                    ...
                    <div class="customer__col">
                      <div class="customer__item">
                        <div class="customer__avatar"><img src="img/content/avatar-2.jpg" alt="Avatar"></div>
                        <div class="customer__description">
                  ...
                  <div class="customer__row">
                    ...
                    <div class="customer__col">
                      <div class="customer__item">
                        <div class="customer__avatar"><img src="img/content/avatar-3.jpg" alt="Avatar"></div>
                        <div class="customer__description">
                  ...
                  <div class="customer__row">
                    ...
                    <div class="customer__col">
                      <div class="customer__item">
                        <div class="customer__avatar"><img src="img/content/avatar-4.jpg" alt="Avatar"></div>
                        <div class="customer__description">
                  ...
                  <div class="customer__row">
                    ...
                    <div class="customer__col">
                      <div class="customer__item">
                        <div class="customer__avatar"><img src="img/content/avatar-5.jpg" alt="Avatar"></div>
                        <div class="customer__description">
                          <div class="customer__user">Chelsie Haley</div>
                          <div class="customer__login">@username</div>
                          <div class="customer__email">chelsie@ui8.net</div>
                  ...
                  <div class="customer__row">
                    ...
                    <div class="customer__col">36</div>
                  </div>
                  <div class="customer__row">
                    <div class="customer__col">
                      <label class="checkbox">
                  ...
                  <div class="customer__row">
                    ...
                    <div class="customer__col">4</div>
                    <div class="customer__col">27</div>
                  </div>
                  <div class="customer__row">
                    <div class="customer__col">
                      <label class="checkbox">
            ...
            <div class="customer__details details">
              ...
              <div class="details__group"><a class="details__line" href="mailto:fahey.designer@robot.co">
                ...
                <div class="details__socials"><a class="details__social" href="https://twitter.com/ui8" target="_blank">
                    <svg class="icon icon-twitter">
                      <use xlink:href="#icon-twitter"></use>
                    </svg></a><a class="details__social" href="https://www.instagram.com/ui8net/" target="_blank">
                    <svg class="icon icon-instagram">
                      <use xlink:href="#icon-instagram"></use>
                    </svg></a><a class="details__social" href="https://www.pinterest.com/ui8m/" target="_blank">
                    <svg class="icon icon-pinterest">
                      <use xlink:href="#icon-pinterest"></use>
                    </svg></a><a class="details__social" href="https://www.facebook.com/ui8.net/" target="_blank">
              ...
              <div class="history">
                <div class="history__label">Purchase history
                  <div class="tooltip" title="Maximum 100 characters. No HTML or emoji allowed" data-position="right">
              ...
              <div class="product__overview">
                ...
                <div class="product__line">
                  <div class="product__author">
                    <div class="product__avatar"><img src="img/content/avatar.jpg" alt="Avatar"></div>by <span>Chelsie
                      Haley</span>
                  </div>
                ...
                <div class="product__gallery">
                  <div class="product__box"><a class="product__preview" href="img/content/photo-1.jpg"
                      data-fancybox="gallery" data-caption="Spectacular views of Queenstown"><img
                        src="img/content/photo-1.jpg" alt="Product"></a><a class="product__preview"
                      href="img/content/photo-2.jpg" data-fancybox="gallery"
                      data-caption="Spectacular views of Queenstown"><img src="img/content/photo-2.jpg"
                        alt="Product"></a><a class="product__preview" href="img/content/photo-1.jpg"
                      data-fancybox="gallery" data-caption="Spectacular views of Queenstown"><img
                        src="img/content/photo-1.jpg" alt="Product"></a><a class="product__preview"
                      href="img/content/photo-2.jpg" data-fancybox="gallery"
                      data-caption="Spectacular views of Queenstown"><img src="img/content/photo-2.jpg"
                        alt="Product"></a>
                  </div><a class="button-white product__button" href="#">Show all preview</a>
                </div>
                <div class="product__row">
                  <div class="product__col">
                    <div class="title-red product__subtitle">Overview</div>
                    <div class="product__content">
                      <p>Meet Node - a crypto NFT marketplace iOS UI design kit for Figma, Sketch, and Adobe XD. The
                        kit
                        includes 126 stylish mobile screens in light and dark mode, a bunch of crypto 3D
                        illustrations,
                        1 SaaS landing page with full premade breakpoints, and hundreds of components to help you ship
                        your next crypto, NFT product faster.</p>
                      <p>Types of screens included: onboarding, connect wallet, home feed, profile, upload, menu,
                        search, product detail, notification...</p>
                      <p>If you have any questions or requests, please feel free to leave them all in the comments
                        section.</p>
                    </div>
                  </div>
                  <div class="product__col">
            ...
            <div class="product__comments comments">
              ...
              <div class="comments__list">
                <div class="comments__item">
                  <div class="comments__avatar"><img src="img/content/avatar-1.jpg" alt="Avatar"></div>
                  <div class="comments__details">
                    ...
                    <div class="comments__content">Purchased the pack and loaded it in Adobe xd (installed fonts as
                      well), some text and titles are off in some screens, is that a compatibility problem with the
                    ...
                    <div class="answer">
                      <div class="answer__avatar"><img src="img/content/avatar.jpg" alt="Avatar" /></div>
                ...
                <div class="comments__answer">
                  ...
                  <div class="comments__details">
                    ...
                    <div class="comments__content">Hi <strong>@ivawelch</strong>, let me check then tell you soon.
                    </div>
                    <div class="comments__control">
                      <button class="comments__favorite">
                        <svg class="icon icon-heart">
                ...
                <div class="comments__item">
                  <div class="comments__avatar"><img src="img/content/avatar-2.jpg" alt="Avatar"></div>
                  <div class="comments__details">
                    <div class="comments__line">
                ...
                <div class="comments__item">
                  <div class="comments__avatar"><img src="img/content/avatar-4.jpg" alt="Avatar"></div>
                  <div class="comments__details">
                    <div class="comments__line">
                ...
                <div class="comments__item">
                  <div class="comments__avatar"><img src="img/content/avatar-3.jpg" alt="Avatar"></div>
                  <div class="comments__details">
                    <div class="comments__line">
      ...
      <div class="popup__wrap js-popup-wrap">
        <div class="share">
          ...
          <div class="share__btns"><a class="button-stroke share__button" href="https://www.facebook.com/ui8.net/"
              ...
              <svg class="icon icon-twitter">
                <use xlink:href="#icon-twitter"></use>
              </svg></a><a class="button-stroke share__button" href="https://www.instagram.com/ui8net/" target="_blank">
              <svg class="icon icon-instagram">
                <use xlink:href="#icon-instagram"></use>
              </svg></a></div>
        </div>
