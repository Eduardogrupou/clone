...
@media (max-width: 375px) {
  ...
  .sidebar.open {
    ...
    <div class="sidebar">
      ...
      </button><a class="sidebar__logo" href="dashboard.php"><img class="some-icon" src="image/logo1.png" alt="Core"><img
          class="some-icon-dark" src="image/logo1.png" alt="Core"></a>
      <div class="sidebar__menu">
          <a class="sidebar__item" href="dashboard.php">
          <svg class="icon icon-home">
            <use xlink:href="#icon-home"></use>
          </svg> <span class="sidebar__item-text">Home</span></a>
       <a class="sidebar__item" href="envios.php">
          <svg class="icon icon-store">
            <use xlink:href="#icon-store">
            </use>
          </svg> <span class="sidebar__item-text">Envios</span></a>
        <a class="sidebar__item" href="subscribed_clientes.php">
          <svg class="icon icon-profile-circle">
            <use xlink:href="#icon-profile-circle"></use>
          </svg> <span class="sidebar__item-text">Clientes</span></a>
          
          <a class="sidebar__item" href="add_ban.php">
          <svg class="icon icon-store">
            <use xlink:href="#icon-store"></use>
          </svg> <span class="sidebar__item-text">Baner</span></a>
        <a class="sidebar__item" href="product.php">
          <svg class="icon icon-promotion">
            <use xlink:href="#icon-promotion"></use>
          </svg> <span class="sidebar__item-text">Perfumes</span></a>
      </div>
      </div>
