                ...
                <div class="customer__table">
                  <div class="customer__row">
                    ...
                    <div class="table-responsive">
                        <table id="dtHorizontalExample" class="table table-striped table-bordered table-sm text-center"
                            cellspacing="0" width="100%">
                            <thead style="background:#505050">

                                <tr>
        <div class="customer__col">  <th>ID</th></div>
    <div class="customer__col">  <th>Cliente</th> </div>
   <div class="customer__col">                                <th>CPF</th></div>
  <div class="customer__col">                             <th>Status</th></div>
    <div class="customer__col">                          <th>Perfume</th></div>
   <div class="customer__col">               <th>Rastreio</th></div>
   <div class="customer__col">              <th>Editar</th></div>
   <div class="customer__col">  <th>Adcionar</th></div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="update_envios.php?id=<?php echo  $row->id ?>">Editar</a>
                                    </td>


                                    <td>
                                        <a href="add_envios.php">Adicionar</a>
                                    </td>
