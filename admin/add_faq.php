					...
					<div class="row p-2">
						<div class="col-md-12">
							<form method="POST" action="action.php" enctype="multipart/form-data">
								...
								<input type="text" class="form-control" placeholder="Question" name="question" style="height:50px">

								<label class="mt-3">Answer</label>
								<input type="text" class="form-control" placeholder="Answer" name="answer" style="height:50px">

								<div class="row mt-3">
									<div class="col-md-12 text-center">
										<button class="btn btn-success" type="submit" name="add_faq">Submit</button>
									</div>
								</div>
							</form>
						</div>
