	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				...
				<span class="breadcrumb-item active">Add Plan</span>
			</div>
					...
					<div class="row p-2">
						<div class="col-md-12">
							<form method="POST" action="action.php" enctype="multipart/form-data">
								<label>Heading</label>
								<input type="text" class="form-control" placeholder="Heading" name="heading" style="height:50px">
								...
								<select class="form-control" name="duration"   style="height: 50px;">
								...
								<div class="row mt-3">
									<div class="col-md-12 text-center">
										<button class="btn btn-success" type="submit" name="add_plan">Submit</button>
									</div>
								</div>
							</form>
						</div>
