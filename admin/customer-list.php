...
.details__btns button:first-child {
background-color: #0070f3;
}

.details__btns button:last-child {
...
.customer__table tbody tr:nth-child(even) {
  background-color: #f2f2f2;
}
        ...
        <div class="page__container">
          <div class="customer__card">
            <div class="card__head">
              ...
              <form class="form">
                <input class="form__input" type="text" name="search" placeholder="Search by name or email" required="required" autocomplete="off"/>
  ...
  <tbody>
    ...
    ?>
      <tr>
        ...
        <td>
            <div class="editar">
          <a href="editar_user.php?id=<?php echo $row->id ?>">Editar</a>
          </div>
        </td>
      </tr>
    <?php
