...
$.extend($.easing, {
    ...
    (function (t) {
        ...
        (Wolmart.$window = t(window)),
            ...
            (Wolmart.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
                navigator.userAgent
            )),
            ...
            (Wolmart.isOnScreen = function (t) {
                var e = window.pageXOffset,
                    ...
                    o = a.top + i;
                return (
                    o + a.height >= i && o <= i + window.innerHeight && n + a.width >= e && n <= e + window.innerWidth
                );
            }),
            ...
            (Wolmart.requestInterval = function (t, e, i) {
                ...
                return (
                    (s.val = a(function r(l) {
                        n || (n = o = l),
                            !i || l - n < i ? (l - o > e ? (t(), (s.val = a(r)), (o = l)) : (s.val = a(r))) : t();
                    })),
                    console.log(s),
                    s
                );
            ...
            (Wolmart.stickyContent = (function () {
                ...
                return (
                    ...
                    (e.prototype.refreshSize = function (t) {
                        var e =
                            window.innerWidth >= this.options.minWidth && window.innerWidth <= this.options.maxWidth;
                        if (
                    ...
                    (e.prototype.refresh = function (t, e) {
                        ...
                        i > this.top && this.isWrap
                            ? ((this.height = a[0].offsetHeight),
                                ...
                                a.is('.fixed.fix-top')
                                    ? ((e.offsetTop += a[0].offsetHeight), (Wolmart.sticky_top_height = e.offsetTop))
                                    : a.is('.fixed.fix-bottom') && (e.offsetBottom += a[0].offsetHeight))
                            : (a.parent().css('height', ''),
            ...
            (Wolmart.initFloatingParallax = function () {
                t.fn.parallax &&
                    Wolmart.$('.floating-item').each(function (e) {
                        var i = t(this);
                        i.data('parallax') &&
                            (i.parallax('disable'), i.removeData('parallax'), i.removeData('options')),
            ...
            (Wolmart.setProgressBar = function (e) {
                Wolmart.$(e).each(function () {
                    ...
                    -1 != i.indexOf('%')
                        ...
                        : -1 != i.indexOf('/') &&
                        (a =
                            (a = parseInt(i.split('/')[0]) / parseInt(i.split('/')[1]) * 100).toFixed(2).toString() +
                            '%'),
            ...
            (Wolmart.priceSlider = function (e, i) {
                'object' == typeof noUiSlider &&
                    Wolmart.$(e).each(function () {
                        ...
                        noUiSlider.create(
                            e,
                            t.extend(!0, { start: [0, 400], connect: !0, step: 1, range: { min: 0, max: 635 } }, i)
                        ),
                ...
                Wolmart.$body.hasClass('home') &&
                    ...
                    Wolmart.$body
                        .on('click', '.sign-in', function (e) {
                            e.preventDefault(),
                                Wolmart.popup({ items: { src: t(e.currentTarget).attr('href') } }, 'login');
                        })
                ...
                close: function (t) {
                    ...
                    (i -= r + this.space),
                        ...
                        a.forEach(function (t, i) {
                            i >= e &&
                                t.hasClass('show') &&
                                t.stop(!0, !0).animate({ top: parseInt(t.css('top')) + r + 20 }, 600, 'easeOutQuint');
                        }),
                        ...
                        if (i.length) {
                            ...
                            (window.pageYOffset <= a || window.innerWidth < 992) && e.removeClass('show'),
                                ...
                                e.on('mouseover', function (t) {
                                    ((e.hasClass('menu-fixed') && window.pageYOffset > a && window.innerWidth >= 992) ||
        ...
        var i = function (t) {
            ...
            if (
                (i.match(/row|gutter\-\w\w|cols\-\d|cols\-\w\w-\d/g) &&
                    e.setAttribute(
                        'class',
                        i.replace(/row|gutter\-\w\w|cols\-\d|cols\-\w\w-\d/g, '').replace(/\s+/, ' ')
                    ),
    ...
    (function (t) {
        ...
        (e.prototype.init = function (e) {
            ...
            return (
                ...
                a.$sidebar.length &&
                ((a.isNavigation =
                    a.$sidebar.hasClass('sidebar-fixed') && a.$sidebar.parent().hasClass('toolbox-wrap')),
                ...
                Wolmart.call(Wolmart.ratingTooltip, 500),
                                    ...
                                    setTimeout(function () {
                                        i.removeClass('load-more-overlay loading'),
                                            Wolmart.Minipopup.open({
                                                ...
                                                imageSrc: a
                                                    .find('.product-media img, .product-image:first-child img')
                                                    .attr('src'),
                    ...
                    (function () {
                        ...
                        function n() {
                            a
                                .find('.title')
                                .after('<p class="compare-count text-center text-light mb-0">(' + e + ' Products)</p>'),
                            ...
                            success: function (e) {
                                ...
                                a.data('load-state', 'loading'),
                                    a.next().hasClass('load-more-overlay')
                                        ...
                                        : t('<div class="mt-4 mb-4 load-more-overlay loading"></div>').insertAfter(a),
                                    setTimeout(function () {
                                ...
                                a.data('load-count', ++n),
                                    n > 2 && window.removeEventListener('scroll', o, { passive: !0 });
                            },
                            failure: function () {
    ...
    (function (t) {
        ...
        (e.defaults = {
            ...
            (e.prototype.init = function (i, a) {
                ...
                function o(e) {
                    !t(e.target).closest('.mfp-content').length || t(e.target).hasClass('mfp-content')
    ...
    (function (t) {
        ...
        var i = function () {
            this.$wrapper
                ...
                .css(
                    'height',
                    window.innerWidth > 767 ? this.$wrapper.find('.product-gallery')[0].clientHeight : ''
                );
        },
            a = function (e) {
                var i = t(this);
            ...
            n = function (e) {
                e.preventDefault(),
                    Wolmart.scrollTo(
                        t('.product-tabs > .nav a[href="' + this.getAttribute('href') + '"]').trigger('click')
                    );
            };
        (e.prototype.init = function (e) {
            var o = this,
            ...
            (o.$wrapper = e),
                ...
                window.addEventListener(
                    ...
                    function () {
                        Wolmart.requestTimeout(function () {
                            null != s.data('slider') &&
                                (s.data('slider').update(), o.$thumbsWrap.data('slider').update());
                        }, 100);
                    },
                    { passive: !0 }
                ),
                ...
                ((o.isStickyScrolling = !1),
                    ...
                    window.addEventListener('scroll', o.scrollStickyThumbnail.bind(this), { passive: !0 })),
                (function (e) {
        ...
        (e.defaultOptions = {
            ...
            (e.prototype.render = function (e, i) {
                ...
                for (var h = c; h < d; h.setDate(h.getDate())) {
                    ...
                    for (u = 0; u < 7; u++) {
                        var g = t(
                            '<td><span class="day" data-date="' + h.toISOString() + '">' + h.getDate() + '</span></td>'
                        );
            ...
            (Wolmart.slideContent = function (e) {
                ...
                i.on('click', function (t) {
                    t.preventDefault(),
                        a.hasClass('open')
                            ? (a.removeClass('open').slideUp(), i.find('.custom-checkbox').removeClass('checked'))
                            : (a.addClass('open').slideDown(), i.find('.custom-checkbox').addClass('checked'));
                });
            }),
